...
are understated by 10%. **WP-06 decision (D18):** stay at standard rates by
...
`scripts/scrub-capture.py` (D17): row structure and every engine-read field
