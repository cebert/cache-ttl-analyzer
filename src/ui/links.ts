/**
 * Outbound URLs, kept out of `ExternalLink.tsx` so that file exports only a
 * component: a module mixing the two trips `react(only-export-components)`
 * and can reset component state on Fast Refresh.
 */
